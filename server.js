...
const INDEX_HTML = 
  ...
  "<div style='font-weight: 700; font-size: 0.85rem; margin-bottom: 4px; color: #10b981;' id='mode-info-title'>⚡ Universal Mobile Stream Active</div><div style='font-size: 0.78rem; color: #94a3b8; line-height: 1.4;' id='mode-info-desc'>Compatible with Galaxy A16 & all Android/iOS mobile devices!</div></div></div></div>" +
...
const PHONE_HTML = 
  ...
  "<button id='btn-start' class='btn-primary' style='width: 100%; padding: 14px; font-size: 1rem;' onclick='startScreenCapture()'>🎬 Start Live Stream / Mirror</button>" +
...
server.listen(PORT, () => {
  console.log(`🚀 UNIVERSAL MOBILE DEVICESTREAM RUNNING ON PORT ${PORT}`);
});

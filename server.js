...
const INDEX_HTML = 
  ...
  "<div style='font-weight: 700; font-size: 0.85rem; margin-bottom: 4px; color: #10b981;' id='mode-info-title'>⚡ Zero-Code QR Scan Active</div><div style='font-size: 0.78rem; color: #94a3b8; line-height: 1.4;' id='mode-info-desc'>Scan the QR Code on PC with your Phone Camera to connect instantly with 1 scan!</div></div></div></div>" +
...
server.listen(PORT, () => {
  console.log(`🚀 DEVICESTREAM PRO V2.0 WITH QR SCANNER RUNNING ON PORT ${PORT}`);
});
